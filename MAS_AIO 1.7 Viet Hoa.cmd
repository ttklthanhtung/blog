...
cls
color 07
title  Microsoft Activation Scripts AIO Viet Hoa By TungBlog
...
cls
color 07
title  Microsoft Activation Scripts AIO 1.7 Viet Hoa By TungBlog
mode 76, 30
...
echo:
echo:                 Phuong Phap Kich Hoat by (tungblog.com):
echo:
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "          " %_Green% "Nhap Mot Tuy Chon Tu Ban Phim [1,2,3,4,5,6,0] :"
choice /C:1234560 /N
set _erl=%errorlevel%
...
echo Dang kiem tra thong tin he thong                        [%winos% ^| %winbuild% ^| %arch%]
...
if %errorlevel% EQU 0 (
echo Dang kiem tra ket noi internet            [Connected]
) else (
set error=1
if defined _intcon (
call :dk_color %Red% "Kiem tra ket noi Internet            [Internet Found But Cant Connect licensing.mp.microsoft.com]"
...
if !errorlevel! EQU 0 (
echo Chuyen doi Windows Region sang USA          [Thanh Cong]
) else (
call :dk_color %Red% "Chuyen doi Windows Region sang USA          [Thai Bai]"
)
)
